...
var ItemDetailPage = /** @class */ (function () {
    ...
    ItemDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-detail',template:/*ion-inline-start:"/home/luis/IonicProjects/parteDosLuisEspin/src/pages/item-detail/item-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ item.bookingId }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <div class="item-detail" padding>\n    <h2><strong>Cliente</strong> : {{item.cliente}}</h2>\n    <p><strong>Fecha de Creación</strong> : {{item.fecha}}</p>\n    <h4><strong>Precio</strong> : {{item.precio}}</h4>\n  </div>\n</ion-content>'/*ion-inline-end:"/home/luis/IonicProjects/parteDosLuisEspin/src/pages/item-detail/item-detail.html"*/
        }),
